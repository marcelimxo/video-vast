	...
	layoutControls: {
		...
		playerInitCallback: function () {
			...
			if (firstPlay) {
				...
				background.style = "background-image:url('https://jtorresdev.github.io/demo-video-vast/samsung/assets/background.png');width:" + width + ';height:' + height + ';background-repeat: no-repeat;';
